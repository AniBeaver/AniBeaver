...
fun TagChipInput(
    ...
    Column(modifier) {
        ...
        // Move chips above the text field for stable height
        FlowRow(
        ...
        Box(modifier = Modifier.fillMaxWidth()) {
            ...
            OutlinedTextField(
                ...
                label = { Text(label) },
                singleLine = true, // Make consistent with name input
                minLines = 1,
                maxLines = 1,
                modifier = Modifier
                    .fillMaxWidth()
                    .heightIn(min = 56.dp, max = 56.dp) // Standard Material height
                    .onGloballyPositioned { coordinates ->
                        textFieldWidth = coordinates.size.width
                    }
                    .focusRequester(focusRequester),
                keyboardOptions = KeyboardOptions.Default,
                // Remove leadingIcon, chips are above now
            )
